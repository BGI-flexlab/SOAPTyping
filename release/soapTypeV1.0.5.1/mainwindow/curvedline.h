...
public:
    ...
    void setCurvedLinePos(QVector<CurvedLine*> *CurvedLinePos){m_pCurvedLinePos = CurvedLinePos;}//新增

    QList<SoapLetter*> getSoapLetterPos(){return m_pLetterList;}//新增
    void getAllSoapLetterPos();//新增
    RegionShowData     *getCuvRegionShowData(){return     cuv_regionShowData;}//新增
    ~CurvedLine();
protected:
...
public slots:
    ...
    void slotbasechanged(char c,int a,int b);//新增
private:

    void  SetColor(QPainter *paint ,char type);
    void  SetColor(QColor &color,char type);//新增
    ...
    QList<SoapLetter*> m_pLetterList;//新增
    QVector<CurvedLine*> *m_pCurvedLinePos;//新增
    QList< QList<SoapLetter*> > m_AllLetterList;//新增
    SoapLetter **m_ppLetter;//新增
