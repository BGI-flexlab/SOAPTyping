...
void createStaticDatabase()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create staticDatabase error!";
    }
}
...
void createGeneTable()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create geneTable error!";
    }
}
...
void createOldGeneTable()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create oldGeneTable error!";
    }
}
...
void createAlleleTable()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create alleleTable error";
    }
}
...
void createLabAlignTable()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create labAlignTable error";
    }
}
...
int loadStaticDatabase()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"load staticDatabase error!";
        QMessageBox mg;mg.setText("load staticDatabase error!");mg.exec(); //新增
        return 1;
    }
    return 0;
}
...
void insertGeneTable(const GeneTable &geneTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Insert Error geneTable";
    }
}
...
void updateGeneTable(const GeneTable &geneTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Update Error geneTable";
    }
}
...
void insertOldGeneTable(const GeneTable &geneTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Insert Error oldGeneTable";
    }
}
void updateOldGeneTable(const GeneTable &geneTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Update Error oldGeneTable";
    }
}
...
void insertAlleleTable(const AlleleTable &alleleTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Insert error allaleTable";
    }
}
void updateAlleleTable(const AlleleTable &alleleTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Update error allaleTable";
    }
}
...
void insertLabAlignTable(const LabAlignTable &labAlignTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Insert error labAlignTable";
    }
}
void updateLabAlignTable(const LabAlignTable &labAlignTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Update error labAlignTable";
    }
}
...
void readGeneTableTxtFile(const QString &geneFile)
{
    ...
    if(!file.exists())
    {
//20180608close qDebug()<<geneFile<<" is not exists!";
        return;
    }
    file.open(QFile::ReadOnly);
    QTextStream stream(&file);
    deleteTable("alleleTable"); //外键数据必须先删除
    ...
    while(!stream.atEnd())
    {
        ...
        if(part.size() != 7)
        {
//20180608close qDebug()<<"read geneFile line Error "<<line;
        }
        GeneTable geneTable;
...
void readAlleleTableTxtFile(const QString &alleleFile)
{
    ...
    if(!file.exists())
    {
//20180608close qDebug()<<alleleFile<<" is not exists!";
        return;
    }
    file.open(QFile::ReadOnly);
    QTextStream stream(&file);
    ...
    while(!stream.atEnd())
    {
        ...
        if(part.size() != 9)
        {
//20180608close qDebug()<<"read alleleFile line Error "<<line;
        }
...
void readLabAlignTableTxtFile(const QString &labAlignFile)
{
    ...
    if(!file.exists())
    {
//20180608close qDebug()<<labAlignFile<<" is not exists!";
        return;
    }
    file.open(QFile::ReadOnly);
    QTextStream stream(&file);
    ...
    while(!stream.atEnd())
    {
        ...
        if(part.size() != 4)
        {
//20180608close qDebug()<<"read labAlignFile line Error "<<line;
        }
...
void createGsspDatabase()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create gsspDatabase error!";
    }
}
...
void createGsspTable()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create gsspTable error";
    }
}
...
int loadGsspDatabase()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"load gsspDatabase error!";
        return 1;
    }
    return 0;
}
...
void insertGsspTable(const GsspTable &gsspTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Insert error gsspTable";
    }
}
void updateGsspTable(const GsspTable &gsspTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Update error gsspTable";
    }
}
...
void readGsspTableTxtFile(const QString &gsspFile)
{
    ...
    if(!file.exists())
    {
//20180608close qDebug()<<gsspFile<<" is not exists!";
        return;
    }
    file.open(QFile::ReadOnly);
    QTextStream stream(&file);
    while(!stream.atEnd())
    {
        ...
        if(part.size() != 6)
        {
//20180608close qDebug()<<"read gsspFile line Error "<<line;
        }
        GsspTable gsspTable;
...
void getGeneNames(QStringList &geneNames)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getGeneNames error";
    }
    else
    {
        while(query.next())
...
//新增
void getVersionNames(QString &versionNames)
{
    QSqlQuery query(staticDatabase);
...
//20180608close qDebug()<<"getGeneNames error";
    ...
    else
    {
        while(query.next())
        {
            versionNames = query.value(0).toString();
        }
    }
}
...
void getGsspNames(QStringList &gsspNames)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getGsspNames error";
    }
    else
    {
        while(query.next())
...
void getGsspMapToExonAndFR(QMap<QString, ExonAndRF> &mapToExonAndFR)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getGsspMapToExonAndFR error";
    }
    else
    {
        while(query.next())
...
void getConsensusSequenceFromStaticDatabase(const QByteArray &geneName, QByteArray &geneSequence, int exonStartPos, int exonLength)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getConsensusSequenceFromStaticDatabase error:"<<geneName;
    }
    else
    {
        while(query.next())
...
void getAlleleInfosFromStaticDatabase(const QByteArray &geneName, int exonStartPos, int alleleLength, int minExonIndex, int maxExonIndex, QVector<AlleleInfo> &alleleInfos, QSet<QString> &shieldAlleles)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getAlleleInfosFromStaticDatabase error:"<<geneName;
    }
    else
    {
        while(query.next())
...
void getGsspAlleleInfosFromStaticDatabase(const QByteArray &geneName, int exonStartPos, int gsspLength, QVector<GsspAlleleInfo> &gsspAlleleInfos, const QString &gsspName)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getGsspInfosFromStaticDatabase error:"<<geneName;
    }
    else
    {
        while(query.next())
...
void extract_exon_info(const QByteArray &gene_name, int exon_index, ExonInfoS& exonInfo)
{
    ...
    bool isSuccess = query.exec();
    if (!isSuccess){
//20180608close qDebug() << "extractExonInfo error";
    }else
    {
        while(query.next())
        {
...
void getAlleleSequence(const QString &alleleName, QByteArray &alleleSeq, int alignStartPos, int alignLength)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getAlleleSequence error"<<alleleName;
    }
    else
    {
        while(query.next())
...
void getGsspPosAndSeqFromGsspDatabase(const QString &gsspName, int &gsspPos, QString &gsspSeq)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getGsspPosAndSeqFromGsspDatabase erorr"<<gsspName;
    }
    else
    {
        while(query.next())
...
void getExonPositionIndexFromStaticDatabase(const QByteArray &geneName, QVector<int> &position)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getExonPositionIndexFromStaticDatabase error"<<geneName;
    }
    else
    {
        while(query.next())
...
void getIndelInfoFromStaticDatabase(const QByteArray &alleleName, IndelInfo &indelInfo)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getIndelInfoFromStaticDatabase error"<<alleleName;
    }
    else
    {
        while(query.next())
...
void getAlleleNameListFromStaticDabase(const QByteArray &geneName, QStringList &alleleNames)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getAlleleNameListFromStaticDabase error"<<geneName;
    }
    else
    {
        while(query.next())
...
void getAlleleSequenceByAlleleName(const QByteArray &alleleName, QString &alleleSeq)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getAlleleSequenceByAlleleName error"<<alleleName;
    }
    else
    {
        while(query.next())
...
void getGsspTablesFromGsspDatabase(const QByteArray &geneName, int exon, QVector<GsspTable> &gsspTables)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getGsspTablesFromGsspDatabase error"<<geneName<<exon;
    }
    else
    {
        while(query.next())
...
void createExonTrimTable()
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"create exonTrimTable error!";
    }
}
...
void readExonTrimTableTxtFile(const QString &exonTrimFile)
{
    ...
    if(!file.exists())
    {
//20180608close qDebug()<<exonTrimFile<<" is not exists!";
        return;
    }
    file.open(QFile::ReadOnly);
    QTextStream stream(&file);
    while(!stream.atEnd())
    {
        ...
        if(part.size() != 8)
        {
//20180608close qDebug()<<"read exonTrimFile line Error "<<line;
        }
...
void insertExonTrim(const ExonTrimTable &exonTrimTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"Insert Error exonTrimTable";
    }
}
...
void updateExonTrim(const ExonTrimTable &exonTrimTable)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"updateExonTrim Error exonTrimTable";
    }
}
...
void getExonTrimListByGeneName(const QString &geneName, QVector<ExonTrimTable> &exonTrimTableList)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getExonTrimListByGeneName error:"<<geneName;
    }
    else
    {
        while(query.next())
...
int getExcludeLeftPosition(const QString &key)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getExcludeLeftPosition error:"<<key;
        return -1;
    }
    else
    {
        if(query.next())
        {
            ...
            if(num>end-start)
            {
//20180608close qDebug()<<"exclude Left Error"<<num<<key;
                return -1;
            }
            return start+num-1;
        }
...
int getExcludeRightPostion(const QString &key)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"getExcludeRightPostion error:"<<key;
        return -1;
    }
    else
    {
        if(query.next())
        {
            ...
            if(num>end-start)
            {
//20180608close qDebug()<<"exclude Right Error"<<num<<key;
                return -1;
            }
            return end-num;
        }
...
bool isIndelInRange(const QByteArray &alleleName, int start, int end)
{
    ...
    if(!isSuccess)
    {
//20180608close qDebug()<<"isIndelInRange error:"<<alleleName;
    }
    else
    {
        while(query.next())
