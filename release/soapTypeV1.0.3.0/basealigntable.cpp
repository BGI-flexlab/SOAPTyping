...
void BaseAlignTable::setBaseAlignTableDefault()
{
    ...
    {
        this->item(0, j)->setTextColor(QColor(0, 0, 223));
        this->item(3, j)->setTextColor(Qt::darkRed);
        this->item(4, j)->setTextColor(QColor(255, 255, 255));
        this->item(5, j)->setTextColor(QColor(0, 0, 223));
        this->item(6, j)->setTextColor(QColor(255, 255, 255));
    ...
    for(int j=1; j<colNum_; j++)
    {
        this->item(1, j)->setBackgroundColor(Qt::white);
        this->item(2, j)->setBackgroundColor(Qt::white);
        this->item(7, j)->setBackgroundColor(Qt::white);
        this->item(8, j)->setBackgroundColor(Qt::white);
        this->item(0, j)->setBackgroundColor(QColor(191, 223, 191));
        this->item(3, j)->setBackgroundColor(QColor(255, 223, 191));
        this->item(4, j)->setBackgroundColor(QColor(223, 223, 223));
        this->item(5, j)->setBackgroundColor(QColor(223, 255, 191));
        this->item(6, j)->setBackgroundColor(QColor(223, 223, 223));
    }
...
void BaseAlignTable::setBaseAlignTableTypeData(int type)
{
    ...
    {
        this->item(6, (*it)-baseAlignSampleInfo_.alignStartPos+startColumn_)->setBackgroundColor(QColor(206, 23, 48));
    }
    emit signalTypeMisMatchPosition(misMatch, type);
}
...
void BaseAlignTable::slotSentBasePos(QTableWidgetItem* item0)
{
    ...
    if(nowPos>=startColumn_ && nowPos<endColumn_)
    {
        ...
        int leftDistance = nowPos*15+168-this->horizontalScrollBar()->sliderPosition();
...
void BaseAlignTable::slotFocusPosition(int basePosition, int exonIndex, int leftDistance)
{
    ...
    int sliderPos = columnPos*15+168-leftDistance;
