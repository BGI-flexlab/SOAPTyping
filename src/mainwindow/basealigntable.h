...
signals:
    ...
    //void signalSelectType(QString &allele1, QString &allele2);ÓÃÓÚpart2;
public slots:
...
private slots:
    ...
    void slotSliderPressed(); //新增
    void slotSliderReleased(); //新增
    void onSliderMoved(int pos); //新增
private:
