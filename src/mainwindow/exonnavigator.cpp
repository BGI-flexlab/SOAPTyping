...
void ExonNavigator::paintEvent(QPaintEvent *e)
{
    ...
    exonPainter.setPen(QColor(211,211,211));
    ...
    for(int i=exonInfo_.minExonIndex; i<=exonInfo_.maxExonIndex; i++)
    {
        ...
        exonPainter.setBrush(QBrush(QColor(235,244,223)));//235,244,223
        ...
        QRect recti(oldPosToNewPos(exonPositionIndex_.at(i-1))*xscale_, 0, (exonPositionIndex_.at(i)-exonPositionIndex_.at(i-1))*xscale_, h0);
        exonPainter.setBrush(Qt::NoBrush);
        ...
        QRect recti1(oldPosToNewPos(exonPositionIndex_.at(i-1))*xscale_, 0, (exonPositionIndex_.at(i)-exonPositionIndex_.at(i-1))*xscale_, h1);
        exonPainter.drawText(recti1, Qt::AlignLeft|Qt::AlignBottom, QString::number(exonPositionIndex_.at(i-1)+1));
        exonPainter.drawText(recti1, Qt::AlignRight|Qt::AlignBottom, QString::number(exonPositionIndex_.at(i)-1+1));
    }
    ...
    if(lastX_ > 0)
    {
        ...
        exonPainter.drawRect(QRect(x-15, top1-15, 30, h1+15));
        exonPainter.setBrush(Qt::NoBrush);
        ...
        exonPainter.setPen(Qt::black);
        exonPainter.drawText(QRect(x-15, 0, 30, h1), Qt::AlignBottom|Qt::AlignCenter, QString::number(lastX_+1));
...
{
//20180608close qDebug("exonnavigator slotFileChanged start");
...
//20180608close qDebug("exonnavigator slotFileChanged end");
}
