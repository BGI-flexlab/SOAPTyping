...
#include<QKeyEvent>
//改，删class ChangeForm:public QDialog
...
signals:
    ...
    void signalAB1Information(QString msgstr);//新增，点击碱基发送碱基当前信息
...
public slots:
    //改，删void slotFocusclik(int,int);
    void slot_inform_other(int,int);
    //改，删void slotbasechanged(char );
...
private:
    ...
    bool isClickTable; //新增
    bool isFileChange; //新增
    //    int * filesxExpandold;
    //    int * filesyExpandold;
    double Space; //新增
    QList<FileInfo_ly> m_FileInfo; //新增
    int alignStart_; //新增
    int alignEnd_; //新增
};
