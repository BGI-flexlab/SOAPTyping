...
int comparePatternWithAllele(char *patternSeq, char *consensusSeq, const QByteArray &geneName, int exonStartPos, int minExonIndex, int maxExonIndex, QMap<int, QString> &typeResult, QSet<QString> &shieldAlleles);
